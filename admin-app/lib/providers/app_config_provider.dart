...
class AppConfigNotifier extends StateNotifier<AppConfig?> {
  ...
  Future<void> updateConfig({
    ...
    try {
      ...
      if (appDescription != null) data['app_description'] = appDescription;
      if (appSubtitle != null) data['app_subtitle'] = appSubtitle;
      ...
      // טעינה מחדש של ההגדרות
      await loadConfig();
    } catch (e) {
      // נשמור על המצב הקודם במקרה של שגיאה
      rethrow;
    }
  }
}
